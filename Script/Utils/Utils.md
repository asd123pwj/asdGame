...
## Enums.gd
- `enum Code`(NULL/OK/NOT_MODIFIED/FORBIDDEN/NOT_FOUND)、`ValueType`(BASE/CUR/MIN/FINAL/MULTIPLIER)、`ModificationMethod`(ADD/SUBTRACT/...)、`KeyStatus`(HOLD/PRESS/RELEASE/POINTER_MOVE)、`LayerType`(地图层)。
