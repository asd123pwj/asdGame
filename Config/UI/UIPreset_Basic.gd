...
var values: Array[Array] = [
    ["MiniHUD", "UI_Panel", {
        ...
        "children": [
            ...
            ["Title", "UI_Label", {
                ...
                "events": [
                    [QName.mouseLeft, "UIInteract.drag $self.parent $event"],
                ],
            }],
            ...
            ["Close", "UI_Label", {
                "content": "[关闭]",
                "events": [
                    [QName.mouseLeft, "UIInteract.close $self.parent"],
                ],
            }],
    ...
    ["ResizeButton", "UI_Image", {
        ...
        "events": [[QName.mouseLeft, "UIInteract.rescale $self.parent $event"]],
    }],
]
