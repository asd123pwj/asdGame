...
public class TilemapAxis: BaseClass{
    ...
    public Vector2 _mapping_inBlockPos_to_worldPos(Vector3Int in_block_pos, Vector3Int block_offsets, LayerType layer_type){
    ...
    public Vector3Int _mapping_worldPos_to_mapPos(Vector3 world_pos, LayerType layer_type){
    ...
    public Vector3Int _mapping_worldPos_to_blockOffsets(Vector3 world_pos, LayerType layer_type){
    ...
    public Vector3Int _mapping_worldPos_to_zoneOffsets(Vector3 world_pos, LayerType layer_type){
        // Vector3Int map_pos = _mapping_worldPos_to_mapPos(world_pos, layer_type);
    ...
    public Vector2 _mapping_mapPos_to_worldPos(Vector3Int map_pos, LayerType layer_type){
